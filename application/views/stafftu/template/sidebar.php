      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($index == 3){ echo 'active'; } ?>" href="<?=base_url('admin/karyawan')?>">
            ...
            <li class="nav-item">
              <a class="nav-link <?php if($index == 4){ echo 'active'; } ?>" href="<?=base_url('admin/kmteam')?>">
                <i class="fa fa-address-book text-blue"></i>
                <span class="nav-link-text">Kelola KM Team</span>
              </a>
            </li> 
             <li class="nav-item">
