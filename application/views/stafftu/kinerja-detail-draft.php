          ...
          <div class="card">
            ...
            <!-- Light table -->
                ...
                <center> 
                    ...
                    <a  href="#" data-toggle="modal" data-target="#mulai" class="btn bg-success text-white">
...
<div class="modal fade" id="mulai" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-success"> 
                  ...
                  <div class="modal-body">
                      ...
                      <div class="py-3 text-center">
                          <i class="ni ni-bell-55 ni-3x"></i>
                          <h4 class="heading mt-4"> Mulai Tahap Penilaian? </h4> 
                      </div>
                  ...
                  <div class="modal-footer">
                      ...
                      <input type="hidden" value="<?=$kinerja->id_kinerja?>" name="id_kinerja">   
                      <input type="submit" class="btn btn-white" name="mulai" value="Mulai">
