        ...
        <div class="col-xl-7 order-xl-1">
          ...
          <div class="card"> 
            <div class="card-body">
              ...
              <form action="<?=base_url('kepalasekolah/profile/')?>" method="POST" id="formprofile">
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="nipx" value="<?=$profil->nip?>">
                        <input required type="nip" class="form-control" id="nip" name="nip" value="<?=$profil->nip?>">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <center> 
                          <input type="submit" name="save" value="Simpan" class="btn bg-primary text-white">
                        </center>
                      </div>
                    </div>
                </div> 
...
<div class="modal fade" id="edit-pw" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('kepalasekolah/profile/')?>" method="POST" id="formgpw">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" name="gpw" value="Simpan"> 
      </div>
      </form>
    </div>
  </div>
