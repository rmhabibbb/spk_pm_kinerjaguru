  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $("#email").keyup(function(){  
        ...
        $cek1 = 0;
          $.ajax({ 
            url:"<?php echo base_url(); ?>kepalasekolah/cekemail",
            method:"post", 
            data:{email:email},
      ...
      $("#formgpw").keyup(function(){  
        ...
        var password = $("#passwordold").val();  
          if (password != '') {
            $.ajax({ 
              url:"<?php echo base_url(); ?>kepalasekolah/cekpasslama",
              method:"post", 
          ...
          if (password != '') {
            $.ajax({ 
              url:"<?php echo base_url(); ?>kepalasekolah/cekpass",
              method:"post", 
              data:{password:password},
                  success:function(data){     
                  if (data != ""){ 
          ...
          var password2 = $("#passwordnew2").val();   
            $.ajax({ 
              url:"<?php echo base_url(); ?>kepalasekolah/cekpass2",
              method:"post", 
