      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
            <a  href="<?=base_url('kepalasekolah')?>" style="color: white">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
           <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kepalasekolah/')?>" >
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kepalasekolah/laporan')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Laporan Kinerja Guru</span>
                  </div>
                </div>
              </a> 
            </li> 
            ...
            <li class="nav-item ">
              <a class="nav-link pr-0" href="<?=base_url('kepalasekolah/profile')?>" >
                <div class="media align-items-center"> 
                  <div class="media-body  ml-2  d-none d-lg-block">
